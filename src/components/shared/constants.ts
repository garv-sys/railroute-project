...
export const LONG_JOURNEY_MIN_VERIFIED_SPLITS = 20;
export const LONG_JOURNEY_SPLIT_AUTO_LIVE_ROUTE_COUNT = 16;
export const LONG_JOURNEY_SPLIT_TOP_UP_ROUTE_COUNT = 10;
