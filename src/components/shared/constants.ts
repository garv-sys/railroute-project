...
export const AUTO_LIVE_DIRECT_LIMIT = 10;
export const SPLIT_AUTO_LIVE_ROUTE_COUNT = 10;
export const SPLIT_PREVIEW_ROUTE_COUNT = 10;
export const LONG_JOURNEY_DISTANCE_KM = 1000;
export const LONG_JOURNEY_MIN_VERIFIED_SPLITS = 10;
export const LONG_JOURNEY_SPLIT_AUTO_LIVE_ROUTE_COUNT = 10;
